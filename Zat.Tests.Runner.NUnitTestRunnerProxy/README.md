# Zat.Tests.Runner.NUnitTestRunnerProxy.Server
...
- The application (`Zat.Tests.Runner.TuiApp`) creates a uniquely named pipe, launches this executable and passes the
...
- The RPC surface is `Zat.Tests.Runner.Common.Services.INUnitTestRunnerProxy`, implemented by `NUnitTestRunnerProxy`.
