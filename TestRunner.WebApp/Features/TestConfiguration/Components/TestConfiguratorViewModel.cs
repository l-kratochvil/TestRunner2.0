    ...
    : ITestConfigurationValidationSource
{
    ...
    public void SetRuntimeVersion(string? runtimeVersion)
    {
        ...
        this.Touch(nameof(ITestConfigurationValidationSource.RuntimeVersion));
    }
    ...
    public void SetTestedHwAssembly(TestedHwAssemblyType? testedHwAssembly)
    {
        ...
        this.Touch(nameof(ITestConfigurationValidationSource.TestedHwAssembly));
    }
    ...
    public void SetTestLinkEnabled(bool isTestLinkEnabled)
    {
        ...
        this.Touch(nameof(ITestConfigurationValidationSource.IsTestLinkEnabled));
    }
    ...
    public void SetIdeVersionText(string? ideVersionText)
    {
        ...
        this.Touch(nameof(ITestConfigurationValidationSource.IdeVersionText));
    }
    ...
    /// Field to ask about, see <see cref="ITestConfigurationValidationSource"/>.
    /// </param>
    /// <returns>
    /// The <see cref="Shared.Validation.Validity"/> of <paramref name="fieldName"/>, and nothing
    /// wrong while the tester has not been there.
    /// </returns>
    public Validity ValidityFor(string fieldName)
        => this.touchedFields.Contains(fieldName) ? this.Validity.For(fieldName) : Validity.Valid;
